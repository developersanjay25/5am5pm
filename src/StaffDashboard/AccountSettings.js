...
const Drawer_Account_staff = () => {
    ...
    const myaccount = () => {
      window.location.href="/app/staffdashboard/myaccount";
    }
        ...
        <React.Fragment>
                ...
                <div className={classes.sidebarStyle3}>
                  <Typography style={{margin:'auto'}} className={classes.emailstyle}><b>Welcome</b>: {data.first_name}</Typography>
                    ...
                    <Typography style={{margin:'auto'}} className={classes.emailstyle}><b>Staff Id</b>: {data.staf_id}</Typography>
